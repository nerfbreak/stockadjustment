...
REASON_CODE           = "SA2"
WAREHOUSE             = "GOOD_WHS"
# Diupdate jadi 60 detik biar anti-timeout pas login/navigasi awal
TIMEOUT_MS            = 60_000 
...
# State untuk nampung data tarikan Newspage
            ...
            with st.container(border=True):
                ...
                if st.button("RUN EXTRACTION JOB", type="primary", use_container_width=True, disabled=not extract_ready):
                    ...
                    def ui_log_np(module, msg):
                        ...
                        display_logs = "<br>".join(logs_history_np[-100:])
                        html_content = f"""
                        <div class="terminal-box" id="term_ext">
                            {display_logs}
                            <br><span class="blink_me">&#9608;</span>
                        </div>
                        <script>
                            var t = window.parent.document.getElementById('term_ext') || document.getElementById('term_ext');
                    ...
                    with st.spinner("Firing up extraction engine..."):
                        ...
                        try:
                            ...
                            with sync_playwright() as p:
                                ...
                                ui_log_np("AUTH", "DOM ready. Filling credentials...")
                                ...
                                try:
                                    ...
                                    ui_log_np("AUTH", "Active session interceptor detected. Bypassing...")
                                ...
                                # FIX DOWNLOAD TIMEOUT: Jadi 4 menit (240000 ms)
