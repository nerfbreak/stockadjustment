...
st.markdown("""
    ...
    .box-np, .box-dist, .box-review, .box-queue {
        ...
        if not bot_user or not bot_pass: 
            ...
            try:
                ...
                with sync_playwright() as p:
                    ...
                    # --- INI OBATNYA: KASIH NAPAS 5 DETIK KE SERVER BIAR POSTBACK-NYA SELESAI ---
                    ui_log("SYS", "Menahan sesi selama 5 detik agar database Newspage selesai menulis...")
                    time.sleep(5)
